...
if(!class_exists('SVB_ADMIN_MENU')) {
    class SVB_ADMIN_MENU
    {
        ...
        public function adminEnqueueScripts()
        {
            ...
            wp_register_script('svb-data-table-script', SVB_DIR . 'inc/assets/js/DataTable.min.js', [], SVB_PLUGIN_VERSION);
            wp_register_script('svb-tailwind-script', SVB_DIR . 'inc/assets/js/tailwind.min.js', [], SVB_PLUGIN_VERSION);

            wp_register_script('svb-admin-script', SVB_DIR . 'dist/admin-script.js', ['svb-data-table-script', 'svb-tailwind-script', 'react', 'react-dom'], SVB_PLUGIN_VERSION);
