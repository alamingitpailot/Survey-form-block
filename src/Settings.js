			...
			<TabPanel className='bPlTabPanel svTabPanel' activeClass='activeTab' tabs={generalStyleTabs} onSelect={tabController}>{tab => <>
				...
				{'style' === tab.name && <>
					<PanelBody className='bPlPanelBody' title={__('Form', 'survey-form-block')} initialOpen={false}>
						<BColor label={__('Background Color', 'survey-form-block')} className="mb10" value={bgColor} onChange={val => updateObject("form", "bgColor", val)} />
						...
						<BColor label={__('Success message color', 'survey-form-block')} className="mb10" value={successMsgColor} onChange={val => updateObject("form", "successMsgColor", val)} />
					</PanelBody>
					...
					<PanelBody className='bPlPanelBody' title={__('Title', 'survey-form-block')} initialOpen={false}>
						...
						<BColor className="mb10" label={__('Color', 'survey-form-block')} value={titleColor} onChange={val => updateObject("form", "titleColor", val)} />
					...
					<PanelBody className='bPlPanelBody' title={__('Description', 'survey-form-block')} initialOpen={false}>
						...
						<BColor className="mb10" label={__('Color', 'survey-form-block')} value={descriptionColor} onChange={val => updateObject("form", "descriptionColor", val)} />
					...
					<PanelBody className='bPlPanelBody' title={__('Label', 'survey-form-block')} initialOpen={false}>
						...
						<BColor label={__('Color', 'survey-form-block')} value={labelS?.color} onChange={val => updateObject("labelS", "color", val)} />
					</PanelBody>
					...
					<PanelBody className='bPlPanelBody' title={__('Input', 'survey-form-block')} initialOpen={false}>
						...
						<BColor className="mb10" label={__('Color', 'survey-form-block')} value={input?.color} onChange={val => updateObject("input", "color", val)} />
					...
					<PanelBody className='bPlPanelBody' title={__('Radio and checkbox label', 'survey-form-block')} initialOpen={false}>
						...
						<BColor label={__('Color', 'survey-form-block')} value={radioCheckLabelColor} onChange={val => setAttributes({ radioCheckLabelColor: val })} />
					</PanelBody>
