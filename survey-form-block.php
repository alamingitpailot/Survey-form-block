...
define('SVB_PLUGIN_VERSION', $plugin_version);

// define('SVB_PLUGIN_VERSION', 'localhost' === $_SERVER['HTTP_HOST']  time() : '1.0.0');
...
class SVB_SURVEY_FORM_BlOCK
{
    ...
    public function enqueueBlockAssets()
    {
        ...
        wp_register_script('svb-survey-script', SVB_DIR . 'dist/script.js', ['react', 'react-dom'], SVB_PLUGIN_VERSION);
